CREATE TABLE %dbpre%weapons (
  wp_num INTEGER PRIMARY KEY,
  wp_type varchar(60) NOT NULL default '',
  wp_desc varchar(40) NOT NULL default '',
  wp_weaptype tinyint(3) NOT NULL default 0,
  wp_secondary tinyint(3) NOT NULL default 0,
  wp_frags int(11) NOT NULL default 0,
  wp_kills int(10) NOT NULL default 0,
  wp_deaths int(10) NOT NULL default 0,
  wp_suicides int(10) NOT NULL default 0,
  wp_nwsuicides int(10) NOT NULL default 0,
  wp_fired int(10) NOT NULL default 0,
  wp_hits int(10) NOT NULL default 0,
  wp_damage bigint(19) NOT NULL default 0,
  wp_chkills mediumint(8) NOT NULL default 0,
  wp_chkills_plr mediumint(8) NOT NULL default 0,
  wp_chkills_gms mediumint(8) NOT NULL default 0,
  wp_chkills_tm bigint(19) NOT NULL default 0,
  wp_chdeaths mediumint(8) NOT NULL default 0,
  wp_chdeaths_plr mediumint(8) NOT NULL default 0,
  wp_chdeaths_gms mediumint(8) NOT NULL default 0,
  wp_chdeaths_tm bigint(19) NOT NULL default 0,
  wp_chdeathshld mediumint(8) NOT NULL default 0,
  wp_chdeathshld_plr mediumint(8) NOT NULL default 0,
  wp_chdeathshld_gms mediumint(8) NOT NULL default 0,
  wp_chdeathshld_tm bigint(19) NOT NULL default 0,
  wp_chsuicides mediumint(8) NOT NULL default 0,
  wp_chsuicides_plr mediumint(8) NOT NULL default 0,
  wp_chsuicides_gms mediumint(8) NOT NULL default 0,
  wp_chsuicides_tm bigint(19) NOT NULL default 0,
  wp_chkillssg mediumint(8) NOT NULL default 0,
  wp_chkillssg_plr mediumint(8) NOT NULL default 0,
  wp_chkillssg_tm bigint(19) NOT NULL default 0,
  wp_chkillssg_map mediumint(8) NOT NULL default 0,
  wp_chkillssg_dt datetime NOT NULL default '0000-00-00 00:00:00',
  wp_chdeathssg mediumint(8) NOT NULL default 0,
  wp_chdeathssg_plr mediumint(8) NOT NULL default 0,
  wp_chdeathssg_tm bigint(19) NOT NULL default 0,
  wp_chdeathssg_map mediumint(8) NOT NULL default 0,
  wp_chdeathssg_dt datetime NOT NULL default '0000-00-00 00:00:00',
  wp_chdeathshldsg mediumint(8) NOT NULL default 0,
  wp_chdeathshldsg_plr mediumint(8) NOT NULL default 0,
  wp_chdeathshldsg_tm bigint(19) NOT NULL default 0,
  wp_chdeathshldsg_map mediumint(8) NOT NULL default 0,
  wp_chdeathshldsg_dt datetime NOT NULL default '0000-00-00 00:00:00',
  wp_chsuicidessg mediumint(8) NOT NULL default 0,
  wp_chsuicidessg_plr mediumint(8) NOT NULL default 0,
  wp_chsuicidessg_tm bigint(19) NOT NULL default 0,
  wp_chsuicidessg_map mediumint(8) NOT NULL default 0,
