CREATE TABLE %dbpre%weapons (
   wp_num smallint NOT NULL identity(1, 1),
   wp_type varchar(60) NOT NULL default '',
   wp_desc varchar(40) NOT NULL default '',
   wp_weaptype tinyint NOT NULL default 0,
   wp_secondary tinyint NOT NULL default 0,
   wp_frags int NOT NULL default 0,
   wp_kills int NOT NULL default 0,
   wp_deaths int NOT NULL default 0,
   wp_suicides int NOT NULL default 0,
   wp_nwsuicides int NOT NULL default 0,
   wp_fired int NOT NULL default 0,
   wp_hits int NOT NULL default 0,
   wp_damage bigint NOT NULL default 0,
   wp_chkills int NOT NULL default 0,
   wp_chkills_plr int NOT NULL default 0,
   wp_chkills_gms int NOT NULL default 0,
   wp_chkills_tm bigint NOT NULL default 0,
   wp_chdeaths int NOT NULL default 0,
   wp_chdeaths_plr int NOT NULL default 0,
   wp_chdeaths_gms int NOT NULL default 0,
   wp_chdeaths_tm bigint NOT NULL default 0,
   wp_chdeathshld int NOT NULL default 0,
   wp_chdeathshld_plr int NOT NULL default 0,
   wp_chdeathshld_gms int NOT NULL default 0,
   wp_chdeathshld_tm bigint NOT NULL default 0,
   wp_chsuicides int NOT NULL default 0,
   wp_chsuicides_plr int NOT NULL default 0,
   wp_chsuicides_gms int NOT NULL default 0,
   wp_chsuicides_tm bigint NOT NULL default 0,
   wp_chkillssg int NOT NULL default 0,
   wp_chkillssg_plr int NOT NULL default 0,
   wp_chkillssg_tm bigint NOT NULL default 0,
   wp_chkillssg_map int NOT NULL default 0,
   wp_chkillssg_dt datetime NOT NULL default '1900-01-01 00:00:00',
   wp_chdeathssg int NOT NULL default 0,
   wp_chdeathssg_plr int NOT NULL default 0,
   wp_chdeathssg_tm bigint NOT NULL default 0,
   wp_chdeathssg_map int NOT NULL default 0,
   wp_chdeathssg_dt datetime NOT NULL default '1900-01-01 00:00:00',
   wp_chdeathshldsg int NOT NULL default 0,
   wp_chdeathshldsg_plr int NOT NULL default 0,
   wp_chdeathshldsg_tm bigint NOT NULL default 0,
   wp_chdeathshldsg_map int NOT NULL default 0,
   wp_chdeathshldsg_dt datetime NOT NULL default '1900-01-01 00:00:00',
   wp_chsuicidessg int NOT NULL default 0,
   wp_chsuicidessg_plr int NOT NULL default 0,
   wp_chsuicidessg_tm bigint NOT NULL default 0,
   wp_chsuicidessg_map int NOT NULL default 0,
   wp_chsuicidessg_dt datetime NOT NULL default '1900-01-01 00:00:00',
   CONSTRAINT wp_num primary key (wp_num)
)

CREATE INDEX wp_type ON %dbpre%weapons (wp_type);
CREATE INDEX wp_weaptype ON %dbpre%weapons (wp_weaptype);
...
#--------------------------------------------------------------------------------------------------
INSERT INTO %dbpre%weapons (wp_type,wp_desc) VALUES('FlameThrowerEX', 'Flamethrower EX');
INSERT INTO %dbpre%weapons (wp_type,wp_desc) VALUES('DamTypeFlameThrowerEX', 'Flamethrower EX');
INSERT INTO %dbpre%weapons (wp_type,wp_desc) VALUES('TransLauncherEX','Translocator EX');
INSERT INTO %dbpre%weapons (wp_type,wp_desc) VALUES('DamTypeTeleFragEX','Translocator EX');
INSERT INTO %dbpre%weapons (wp_type,wp_desc) VALUES('DamTypeTelefraggedEX','Telefragged EX');
INSERT INTO %dbpre%weapons (wp_type,wp_desc) VALUES('ShieldGunEX','Shield Gun EX');
INSERT INTO %dbpre%weapons (wp_type,wp_desc) VALUES('DamTypeShieldImpactEX','Shield Gun EX');
INSERT INTO %dbpre%weapons (wp_type,wp_desc) VALUES('AssaultRifleEX','Assault Rifle EX');
INSERT INTO %dbpre%weapons (wp_type,wp_desc) VALUES('DamTypeAssaultBulletEX','Assault Rifle EX');
INSERT INTO %dbpre%weapons (wp_type,wp_desc,wp_secondary) VALUES('DamTypeAssaultGrenadeEX','Assault Rifle EX',1);
INSERT INTO %dbpre%weapons (wp_type,wp_desc) VALUES('LinkGunEX','Link Gun EX');
INSERT INTO %dbpre%weapons (wp_type,wp_desc) VALUES('DamTypeLinkPlasmaEX','Link Gun EX');
INSERT INTO %dbpre%weapons (wp_type,wp_desc,wp_secondary) VALUES('DamTypeLinkShaftEX','Link Gun EX',1);
INSERT INTO %dbpre%weapons (wp_type,wp_desc) VALUES('ShockRifleEX','Shock Rifle EX');
INSERT INTO %dbpre%weapons (wp_type,wp_desc) VALUES('DamTypeShockBeamEX','Shock Rifle EX');
INSERT INTO %dbpre%weapons (wp_type,wp_desc,wp_secondary) VALUES('DamTypeShockBallEX','Shock Rifle EX',1);
INSERT INTO %dbpre%weapons (wp_type,wp_desc,wp_secondary) VALUES('DamTypeShockComboEX','Shock Rifle EX',2);
INSERT INTO %dbpre%weapons (wp_type,wp_desc) VALUES('BioRifleEX','Bio Rifle EX');
INSERT INTO %dbpre%weapons (wp_type,wp_desc) VALUES('DamTypeBioGlobEX','Bio Rifle EX');
INSERT INTO %dbpre%weapons (wp_type,wp_desc) VALUES('MinigunEX','Minigun EX');
INSERT INTO %dbpre%weapons (wp_type,wp_desc) VALUES('DamTypeMinigunBulletEX','Minigun EX');
INSERT INTO %dbpre%weapons (wp_type,wp_desc,wp_secondary) VALUES('DamTypeMinigunAltEX','Minigun EX',1);
INSERT INTO %dbpre%weapons (wp_type,wp_desc) VALUES('FlakCannonEX','Flak Cannon EX');
INSERT INTO %dbpre%weapons (wp_type,wp_desc) VALUES('DamTypeFlakChunkEX','Flak Cannon EX');
INSERT INTO %dbpre%weapons (wp_type,wp_desc,wp_secondary) VALUES('DamTypeFlakShellEX','Flak Cannon EX',1);
INSERT INTO %dbpre%weapons (wp_type,wp_desc,wp_secondary) VALUES('FlakDeathEX','Flak Cannon EX',1);
INSERT INTO %dbpre%weapons (wp_type,wp_desc) VALUES('RocketLauncherEX','Rocket Launcher EX');
INSERT INTO %dbpre%weapons (wp_type,wp_desc) VALUES('DamTypeRocketEX','Rocket Launcher EX');
INSERT INTO %dbpre%weapons (wp_type,wp_desc,wp_secondary) VALUES('DamTypeRocketHomingEX','Rocket Launcher EX',1);
INSERT INTO %dbpre%weapons (wp_type,wp_desc,wp_secondary) VALUES('RocketDeathEX','Rocket Launcher EX',1);
INSERT INTO %dbpre%weapons (wp_type,wp_desc) VALUES('LightningGunEX','Lightning Gun EX');
INSERT INTO %dbpre%weapons (wp_type,wp_desc) VALUES('SniperRifleEX','Lightning Gun EX');
INSERT INTO %dbpre%weapons (wp_type,wp_desc) VALUES('DamTypeSniperShotEX','Lightning Gun EX');
INSERT INTO %dbpre%weapons (wp_type,wp_desc,wp_secondary) VALUES('DamTypeSniperHeadShotEX','Lightning Gun EX',1);
INSERT INTO %dbpre%weapons (wp_type,wp_desc) VALUES('RedeemerEX','Redeemer EX');
INSERT INTO %dbpre%weapons (wp_type,wp_desc) VALUES('DamTypeRedeemerEX','Redeemer EX');
INSERT INTO %dbpre%weapons (wp_type,wp_desc) VALUES('RedeemerDeathEX','Redeemer EX');
INSERT INTO %dbpre%weapons (wp_type,wp_desc) VALUES('DamTypeIonBlastEX','Ion Cannon EX');
INSERT INTO %dbpre%weapons (wp_type,wp_desc) VALUES('ClassicDamTypeSniperShotEX','Classic Sniper Rifle EX');
INSERT INTO %dbpre%weapons (wp_type,wp_desc) VALUES('ClassicDamTypeSniperHeadShotEX','Classic Sniper Rifle EX');
INSERT INTO %dbpre%weapons (wp_type,wp_desc) VALUES('PainterEX','Ion Cannon EX');
INSERT INTO %dbpre%weapons (wp_type,wp_desc) VALUES('ONSAVRiLEX','AVRiL EX');
INSERT INTO %dbpre%weapons (wp_type,wp_desc) VALUES('DamTypeONSAVRiLRocketEX','AVRiL EX');
INSERT INTO %dbpre%weapons (wp_type,wp_desc) VALUES('ONSMineLayerEX','Mine Layer EX');
INSERT INTO %dbpre%weapons (wp_type,wp_desc) VALUES('DamTypeONSMineEX','Mine Layer EX');
INSERT INTO %dbpre%weapons (wp_type,wp_desc) VALUES('ONSGrenadeLauncherEX','Grenade Launcher EX');
INSERT INTO %dbpre%weapons (wp_type,wp_desc) VALUES('DamTypeONSGrenadeEX','Grenade Launcher EX');
INSERT INTO %dbpre%weapons (wp_type,wp_desc) VALUES('ClassicSniperRifleEX','Sniper Rifle EX');
INSERT INTO %dbpre%weapons (wp_type,wp_desc) VALUES('DamTypeClassicSniperEX','Sniper Rifle EX');
